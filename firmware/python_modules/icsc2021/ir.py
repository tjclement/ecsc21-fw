...
class BadgeIr:
    ...
    def __init__(self, pins=None, badge=None, freq=38000):
        ...
        if pins:
            ...
            raise (
                "Please provide badge name or pin numbers [rx, tx, rxEnable], enter -1 for rxEnable if it is not used!"
            )
