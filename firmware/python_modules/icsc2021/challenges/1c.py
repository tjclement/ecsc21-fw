...
def render():
    ...
    for i in range(num_lines):
        display.drawText(0, y, '{:08X}: {}\n'.format(_cur_address+(i*16), data[(i*16):(i*16)+16]), 0xFFFFFF, line_font)
        y += line_height + 2
...
_message_ui = 'Extract the flag from flash storage. Use the device, or connect via usb ' \
