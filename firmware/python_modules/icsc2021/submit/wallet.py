...
def check():
    while True:
        ...
        if wallet == "14ocYc2N3TG4oxZEnx8te76NCuhTdySPzJ":
            ...
            flags.submit_flag(
                "CTF{%s}" % "3f760b3a9eadc00b29de09c405d0b0d5ba2459efc3ea52d8"
            )
            break
        else:
            print(
                "Our systems indicate that this address is invalid or not likely associated with the Sixth Circle."
            )
